...
| Arctic Embed M v1.5 + WordPiece vocabulary | Required embedding/RAG model and tokenizer. | `Snowflake/snowflake-arctic-embed-m-v1.5`, pinned revision `e58a8f756156a1293d763f17e3aae643474e9b8a`, Apache-2.0. | **HOLD:** public versioned prerelease assets are anonymously downloadable and match pinned SHA-256 values, but GitHub reports `immutable=false`. Enabling immutable-release protection requires repository admin permission unavailable to this account. |

...
> **Historical snapshot:** The EmbeddingGemma findings below describe the 2026-05-30 catalogue and UI; issue #1559 Phase B supersedes that embedding inventory with Arctic Embed M v1.5. Its required public assets remain blocked on immutable-release hosting.

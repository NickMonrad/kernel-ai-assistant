...
**Run ID:** `on_device-2026-07-02T02-25-42Z-s21-exynos`

| Scenario | Functional | UX | Steps | Taps | Settings hops | Back | Duration |
|---|---|---|---:|---:|---:|---:|---:|
| Dashboard reflects microphone permission revoked externally via ADB | fail | fail | 9 | 2 | 0 | 0 | 30.9s |
| Dashboard reflects location permission revoked externally via ADB | fail | fail | 9 | 2 | 0 | 0 | 31.4s |
...
- UX result: `fail`
- UX warnings: duration 30.9s > 30s
- Steps:
  ...
  - 08. `navigate_to_permissions_post_revoke` — fail: Target not visible within 8s: text='App Permissions'; visible sample=['Page 1 of 5.', 'Time & weather 2', '12', '26', 'pm', 'Thu', 'Jul 02', 'Brisbane'] (`screenshots/08-stale-state-dashboard-reflects-external-mic-revoke-navigate-to-permissions-post-revoke.png`)
  - 10. `reset_mic_after_stale_test` — pass: Permissions set to prompt: android.permission.RECORD_AUDIO
...
- Functional result: `fail`
- UX result: `fail`
- UX warnings: duration 31.4s > 30s
- Steps:
  ...
  - 08. `navigate_to_permissions_post_revoke` — fail: Target not visible within 8s: text='App Permissions'; visible sample=['Page 1 of 5.', 'Time & weather 2', '12', '26', 'pm', 'Thu', 'Jul 02', 'Brisbane'] (`screenshots/08-stale-state-dashboard-reflects-external-location-revoke-navigate-to-permissions-post-revoke.png`)
  - 10. `reset_location_after_stale_test` — pass: Permissions set to prompt: android.permission.ACCESS_COARSE_LOCATION, android.permission.ACCESS_FINE_LOCATION

...
class ToolsHubNavTest {
    ...
    fun toolsHub_rendersExpectedGroupsAndRows() {
        ...
        listOf(
            ...
            "tools_row_clock",
            "tools_row_clock_stopwatch",
            "tools_row_clock_timer",
            "tools_row_clock_alarms",
            "tools_row_clock_world_clock",
            "tools_row_important_dates",
            "tools_row_people_contacts",
            "tools_row_convert",
            "tools_row_convert_currency",
            "tools_row_convert_unit",
            "tools_row_convert_cooking",
            "tools_row_settings",
            "tools_row_voice",
            "tools_row_models",

...
internal object UnitConversionEvaluator {
    ...
    enum class SupportedUnit(
        ...
        MILLILITER(
            ...
            baseFactor = BigDecimal.ONE,
            aliases = setOf("ml", "milliliter", "milliliters", "millilitre", "millilitres"),
        ),
        LITER(
            category = UnitCategory.VOLUME,
            canonicalName = "L",
            ...
            baseFactor = BigDecimal("1000"),
            aliases = setOf("l", "liter", "liters", "litre", "litres"),
        ),
        TEASPOON(
            category = UnitCategory.VOLUME,
            canonicalName = "tsp",
        ...
        METERS_PER_SECOND(
            ...
            aliases = setOf("m/s", "mps", "meter per second", "meters per second", "metre per second", "metres per second"),
        ),
        KILOMETERS_PER_HOUR(
            category = UnitCategory.SPEED,
            canonicalName = "km/h",
